...
- The direct-above probe position is three blocks above the player's feet so
  its temporary support barrier remains above the player's head and does not
  push or interrupt movement.
